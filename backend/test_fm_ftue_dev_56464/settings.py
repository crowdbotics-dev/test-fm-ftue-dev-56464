"""
Django settings for test_fm_ftue_dev_56464 project.
...
ROOT_URLCONF = 'test_fm_ftue_dev_56464.urls'
...
WSGI_APPLICATION = 'test_fm_ftue_dev_56464.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_fm_ftue_dev_56464 API",
    "DESCRIPTION": "API documentation for test_fm_ftue_dev_56464 App",
    "VERSION": "v1",
}
